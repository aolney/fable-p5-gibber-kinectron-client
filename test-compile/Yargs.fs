...
module Yargs =
    ...
    type [<AllowNullLiteral>] Argv =
        ...
        abstract middleware: callbacks: U2<MiddlewareFunction, ResizeArray<MiddlewareFunction>> -> Argv
        ...
        abstract scriptName: ``$0``: string -> Argv
        abstract showCompletionScript: unit -> Argv
        abstract showHidden: ?option: U2<string, bool> -> Argv
        abstract showHidden: option: string * ?description: string -> Argv
    ...
    type [<AllowNullLiteral>] MiddlewareFunction =
        [<Emit "$0($1...)">] abstract Invoke: args: Arguments -> unit
