...
module rec p5 = 
    ...
    type [<AllowNullLiteral>] p5 =
        ...
        /// including draw().
        abstract setup: (unit -> unit) with get, set
        ...
        /// effect.
        abstract draw: (unit -> unit) with get, set
        ...
        /// texture</param>
        //TODO: MediaElement undefined! abstract texture: tex: U3<Image, MediaElement, Graphics> -> p5
    ...
    type [<AllowNullLiteral>] p5Static =
        ...
        [<Emit "new $0($1...)">] abstract Create: sketch: (obj -> unit) * ?node: U2<HTMLElement, bool> * ?sync: bool -> p5


        type UNKNOWN_P5_CONSTANT =
            obj option

    // let [<Import("TypedDictStatic","@types/p5/src/data/p5.TypedDict")>] TypedDict: TypedDictStatic = jsNative
    // let [<Import("NumberDictStatic","@types/p5/src/data/p5.TypedDict")>] NumberDict: NumberDictStatic = jsNative
    // let [<Import("StringDictStatic","@types/p5/src/data/p5.TypedDict")>] StringDict: StringDictStatic = jsNative
    // let [<Import("*","@types/p5/src/io/files")>] PrintWriter: PrintWriterStatic = jsNative
    // let [<Import("*","@types/p5/src/webgl/p5.Camera")>] Camera: CameraStatic = jsNative
    // let [<Import("*","@types/p5/src/color/p5.Color")>] Color: ColorStatic = jsNative
    // let [<Import("*","@types/p5/src/core/p5.Element")>] Element: ElementStatic = jsNative
    // let [<Import("*","@types/p5/src/core/p5.Graphics")>] Graphics : GraphicsStatic = jsNative
    // let [<Import("*","@types/p5/src/image/p5.Image")>] Image: ImageStatic = jsNative
    // let [<Import("*","@types/p5/src/io/p5.Table")>] Table: TableStatic = jsNative
    // let [<Import("*","@types/p5/src/io/p5.TableRow")>] TableRow: TableStatic = jsNative
    // let [<Import("*","@types/p5/src/io/p5.XML")>] XML: XMLStatic = jsNative
    // let [<Import("*","@types/p5/src/math/p5.Vector")>] Vector: VectorStatic = jsNative
    // let [<Import("*","@types/p5/src/typography/p5.Font")>] Font: FontStatic = jsNative
    // let [<Import("*","@types/p5/src/webgl/p5.Geometry")>] Geometry: GeometryStatic = jsNative
    // let [<Import("*","@types/p5/src/webgl/p5.Shader")>] Shader: ShaderStatic = jsNative
    // let [<Import("*","@types/p5/src/core/p5.Renderer")>] Renderer: RendererStatic = jsNative
    // let [<Import("*","p5")>] p5: p5Static = jsNative

    let [<Import("TypedDict","p5")>] TypedDict: TypedDictStatic = jsNative
    let [<Import("NumberDict","p5")>] NumberDict: NumberDictStatic = jsNative
    let [<Import("StringDict","p5")>] StringDict: StringDictStatic = jsNative
    let [<Import("PrintWriter","p5")>] PrintWriter: PrintWriterStatic = jsNative
    let [<Import("Camera","p5")>] Camera: CameraStatic = jsNative
    let [<Import("Color","p5")>] Color: ColorStatic = jsNative
    let [<Import("Element","p5")>] Element: ElementStatic = jsNative
    let [<Import("Graphics","p5")>] Graphics : GraphicsStatic = jsNative
    let [<Import("Image","p5")>] Image: ImageStatic = jsNative
    let [<Import("Table","p5")>] Table: TableStatic = jsNative
    let [<Import("TableRow","p5")>] TableRow: TableStatic = jsNative
    let [<Import("XML","p5")>] XML: XMLStatic = jsNative
    let [<Import("Vector","p5")>] Vector: VectorStatic = jsNative
    let [<Import("Font","p5")>] Font: FontStatic = jsNative
    let [<Import("Geometry","p5")>] Geometry: GeometryStatic = jsNative
    let [<Import("Shader","p5")>] Shader: ShaderStatic = jsNative
    let [<Import("Renderer","p5")>] Renderer: RendererStatic = jsNative
    let [<Import("*","p5")>] p5: p5Static = jsNative